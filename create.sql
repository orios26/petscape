...
create table customers (customer_id int8 not null, street_address varchar(255), city varchar(255), email varchar(255), first_name varchar(255), last_name varchar(255), state varchar(255), zip int4, primary key (customer_id))
